...
public class verifyAddProductAndPlaceOrder extends SauceDemoBaseTest {
    ...
    public void TC_005_testAddProductAndPlaceOrder() throws Exception {
        ...
        String fullProductXpath = SauceDemoXpathRepo.productNamePrefix + givenProduct
                + SauceDemoXpathRepo.productNameSuffix;
        ...
        logToExtent("Details Added into Information page - First Name : " + firstName + ", Last Name : " + lastName
                + ", ZipCode : " + zipCode);
